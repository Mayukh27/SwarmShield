  ...
  return (
    <div>
      ...
      <div className="p-6 lg:p-8">
        ...
        {/* Filters */}
        <div className="mt-6 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.025] p-4 backdrop-blur-xl md:flex-row">
          <input
        ...
        {/* Vulnerability table */}
        <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025] backdrop-blur-xl">
