    ...
    <main className="relative min-h-screen overflow-hidden bg-[#030508] text-white">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5 py-10">
        ...
        <div className="w-full max-w-md">
          ...
          {/* Login card */}
          <div className="rounded-3xl border border-white/10 bg-black/45 p-7 shadow-2xl backdrop-blur-2xl sm:p-8">
          ...
          <p className="mt-6 text-center text-[9px] text-white/15">
            SwarmShield · Autonomous Multi-Agent Security Platform
          </p>
