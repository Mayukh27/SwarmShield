    ...
    <div>
      ...
      <div className="p-6 lg:p-8">
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-3">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025] backdrop-blur-xl xl:col-span-1">
          ...
          <div className="xl:col-span-2">
            ...
            {/* CODE DIFF */}
            <div className="mt-6 overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl">
