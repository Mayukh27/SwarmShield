    ...
    <div className="flex h-full flex-col items-center justify-center gap-6 overflow-y-auto px-6 py-10 text-center">
      ...
      {openCount > 0 && (
        <button
          ...
          className="rounded-xl border border-gold/40 bg-gold-dim px-4 py-2 font-mono text-xs font-semibold text-gold transition-colors hover:bg-gold/20 hover:shadow-glow"
        >
...
function Stat({ icon, value, tone, label }) {
  return (
    <div className="flex flex-col items-center gap-1 rounded-2xl border border-grid/80 bg-panel/70 px-4 py-4 backdrop-blur-xl">
