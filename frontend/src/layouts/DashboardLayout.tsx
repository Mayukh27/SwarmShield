    ...
    <div className="relative min-h-screen overflow-hidden bg-[#05030a] text-white">
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-64 border-r border-white/[0.07] bg-[#05030a]/75 backdrop-blur-2xl lg:block">
        ...
        <div className="flex h-20 items-center border-b border-white/[0.07] px-6">
          ...
          <div className="mr-3 flex h-9 w-9 items-center justify-center rounded-xl border border-amber-400/25 bg-amber-400/[0.08] shadow-[0_0_25px_rgba(251,191,36,0.14)]">
        ...
        <div className="glass absolute bottom-5 left-4 right-4 rounded-xl p-4">
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `group relative flex h-11 items-center gap-3 rounded-xl px-4 text-xs transition-all duration-300 ${
          isActive
            ? "border border-amber-400/30 bg-amber-400/[0.08] text-amber-300 shadow-[0_0_20px_rgba(251,191,36,0.08)]"
    ...
    >
      {({ isActive }) => (
        <>
          ...
          {isActive && (
            <span className="absolute right-3 h-1 w-1 rounded-full bg-amber-300 shadow-[0_0_10px_rgba(251,191,36,0.9)]" />
          )}
        </>
      )}
    </NavLink>
