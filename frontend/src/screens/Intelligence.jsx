...
function StatChip({ label, value, tone }) {
  return (
    <div className="flex flex-col items-center gap-0.5 rounded border border-grid bg-panel-raised px-3 py-2">
    ...
    <div className="mx-auto flex h-full max-w-5xl flex-col gap-5 overflow-y-auto px-5 py-6">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          onClick={load}
          disabled={loading}
          className="shrink-0 rounded border border-gold/40 bg-gold-dim px-3 py-1.5 font-mono text-xs font-medium text-gold hover:bg-gold/20 disabled:opacity-50"
        >
        ...
        <>
          ...
          {unknown.length > 0 && (
            <div className="flex flex-col gap-2">
              {unknown.map((c) => (
                <div
                  key={c.capability_id}
                  className="rounded-lg border border-critical/50 bg-critical-dim px-4 py-3"
                >
            ...
            {caps.length === 0 ? (
              ...
              <div className="flex flex-col gap-1.5">
                {caps.map((c) => {
                  ...
                  return (
                    <div key={c.capability_id} className="rounded-lg border border-grid bg-panel">
                      <button
          ...
          <section>
            ...
            {attackPaths.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {attackPaths.map((p) => (
                  <div key={p.path_id} className="rounded-lg border border-grid bg-panel px-3 py-2">
            ...
            {hypotheses.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {hypotheses.map((h) => {
                  ...
                  return (
                    <div key={h.hypothesis_id} className="rounded-lg border border-grid bg-panel">
                      <button
